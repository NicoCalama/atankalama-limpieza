...
/**
 * Migración: agrega el espejo crudo del roomName de Cloudbeds a la ficha de habitación.
 *
 *   habitaciones: cloudbeds_room_name (nullable)
 *
 ...
 * propio: lo hace el próximo InventarioImportService::sincronizar() de Cloudbeds.
 */
...
echo "Nombre completo de Cloudbeds:\n";
$agregar('habitaciones', 'cloudbeds_room_name', 'TEXT', 'VARCHAR(150) NULL');
