...
final class Ticket
{
    ...
    public function __construct(
        ...
        public readonly ?string $asignadoAt,
    ...
    public static function desdeFila(array $fila): self
    {
        return new self(
            id: (int) $fila['id'],
            habitacionId: isset($fila['habitacion_id']) ? (int) $fila['habitacion_id'] : null,
            ...
            asignadoA: isset($fila['asignado_a']) ? (int) $fila['asignado_a'] : null,
            asignadoAt: isset($fila['asignado_at']) ? (string) $fila['asignado_at'] : null,
