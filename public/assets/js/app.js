...
// --- Badges de ocupación de Cloudbeds (compartidos) ---
// Una sola versión para la ficha del trabajador (habitacion-detalle.php), la lista de
// Habitaciones y la bandeja de Inspección: la supervisora ve exactamente lo mismo que
// vio el trabajador. Ver docs/ocupacion-y-sabanas.md.

// Badge de ocupación (frontdeskStatus de Cloudbeds). 'unused' (libre) → sin badge.
function htmlBadgeOcupacion(fs) {
    var map = {
...
function htmlBadgeCodigoRoomName(nombreCompleto) {
